...
def getCoreRelations(method = 'rename'):
    ...
    if reveal_globals.global_db_engine != 'Microsoft SQL Server':
        try:
            ...
            reveal_globals.error= "Can not obtain table names. Error: " +dict(error.args[0])['M']
    ...
    if method == 'rename': 
        ...
        for tabname in reveal_globals.global_all_relations:
            try:
                ...
                #error test
                # e = exc_info()[1]
                print("loc 1    :",dict(error.args[0])['M'])
                reveal_globals.error="Unmasque Error: \n Error Occurred in table extraction.\n Postgres Error: \n" + dict(error.args[0])['M']
    ...
    core_relations=list(set(core_relations))
